...
public class Stack_Page {
	public Stack_Page(WebDriver webDriver ) {
		PageFactory.initElements(webDriver, this);
	}

	@FindBy(xpath = "//input[@id='id_username']") WebElement inputUsername;
	@FindBy(xpath = "//input[@id='id_password']") WebElement inputPassword;
	@FindBy(xpath = "//input[@value='Login']") WebElement btnLogin;
	@FindBy(xpath = "//h5[text()='Stack']/../a[text()='Get Started']") WebElement hrefGetStarted;
	@FindBy(xpath = "//h4[text()='Stack']") WebElement stackPage;
	@FindBy (linkText="Sign in") WebElement signIn;
	@FindBy(xpath = "//a[text()='Operations in Stack']") WebElement operationsInStackLink;
	@FindBy(xpath = "//p[text()='Operations in Stack']") WebElement operationsInStackPage;
	@FindBy(xpath = "//a[text()='Implementation']") WebElement implementationLink;
	@FindBy(xpath = "//p[text()='Implementation']") WebElement implementationPage;
	@FindBy(xpath = "//a[text()='Applications']") WebElement applicationLink;
	@FindBy(xpath = "//p[text()='Applications']") WebElement applicationPage;
	@FindBy(xpath = "//a[text()='Try here>>>']") WebElement btnTryhere;
	@FindBy(xpath = "//button[text()='Run']") WebElement btnRun;
	@FindBy(xpath = "//form[@id='answer_form']/div/div/div/textarea") WebElement inputEditor;
	@FindBy(xpath = "//pre[@id='output']") WebElement ouputEditor;
	@FindBy(xpath = "//a[text() = 'Practice Questions']") WebElement practiceQuestionsLink;
	@FindBy(xpath = "//p[text() = ' Practice Questions']") WebElement practiceQuestionsPage;
	@FindBy (xpath="//a[contains(text(),'Data Structures')]") WebElement dsDropDown;
	@FindBy (xpath="//a[text()='Stack']") WebElement stackDropDownValue;
